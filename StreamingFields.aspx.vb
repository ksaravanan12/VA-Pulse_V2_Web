    ...
    Partial Class StreamingFields
        ...
        Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
            ...
            If Not (g_UserRole = enumUserRole.Engineering Or g_UserRole = enumUserRole.Admin Or g_UserRole = enumUserRole.Support) Then
                PageVisitDetails(g_UserId, "Streaming Fields Report Details", enumPageAction.AccessViolation, "user try to access report details List")
