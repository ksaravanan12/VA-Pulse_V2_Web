...
Namespace GMSUI
    Partial Class DeviceDetailsReport
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Not IsPostBack Then
                ...
                If g_UserRole <> enumUserRole.Admin And g_UserRole <> enumUserRole.Engineering And g_UserRole <> enumUserRole.Support Then
                    PageVisitDetails(g_UserId, "Device Details Report", enumPageAction.AccessViolation, "")
                ...
                Try
                    PageVisitDetails(g_UserId, "Device Details Report", enumPageAction.View, "user visited Device Details Report")
                Catch ex As Exception
                    WriteLog(" Device Details Report - UserId " & g_UserId & ex.Message.ToString())
                End Try
