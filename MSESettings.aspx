<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="MSESettings.aspx.vb" Title="MSE Settings" Inherits="GMSUI.MSESettings" %>
...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" language="javascript" src="Javascript/js_SetupMSESettings.js?d=103"></script>
            ...
            <td>
                <div>
                    <table border="0" cellpadding="0" cellspacing="0" width="85%">
                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="5" cellspacing="5" width="1000px" class="clsFilterRow"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:dropdownlist id="ddlSites" runat="server" style="width: 400px;" onchange="LoadMSESettings()">
                                                </asp:dropdownlist>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <tr>
                            <td valign="top">
                                <table id="tblMSESettingsListInfo" cellspacing="1" cellpadding="3" style="width: 100%;
                        ...
                        <tr>
                            <td valign="top">
                                <table id="tblMSESettingsHistoryListInfo" cellspacing="1" cellpadding="3" style="width: 100%;
                                    padding-top: 10px;" class="display">
                                </table>
                            </td>
                        </tr>
