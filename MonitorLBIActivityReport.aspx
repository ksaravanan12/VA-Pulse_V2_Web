<%@ Page Title="Monitor LBI Activity Report" Language="VB" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="false" CodeFile="MonitorLBIActivityReport.aspx.vb" Inherits="GMSUI.MonitorLBIActivityReport" %>
...
<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="85%">
        ...
        <tr>
            <td>
                <table style="padding-left: 10px; padding-bottom: 10px; width: 100%;">
                    <tr>
                        <td align="left" class="clsLALabel" style="white-space: nowrap;">
                            LBI&nbsp;Chart&nbsp;:&nbsp;
                            <asp:dropdownlist id="DDListLBI" runat="server" autopostback="true">
                            </asp:dropdownlist>
                            &nbsp;<asp:checkbox id="ChkRemoveFilter" runat="server" autopostback="true" class="clsCheckBox" />&nbsp;Remove
                            Zero Filter
                        </td>
        ...
        <tr>
            <td style="padding-left: 10px; padding-right: 10px;">
                <table cellpadding="5" cellspacing="0" style="width: 70%;" border="0">
                    <tr id="TRFusionZoomongLBI" runat="server" visible="false">
                        <td>
                            <div id="BarGraph2" style="width: 70%; height: 400;">
                            </div>
                            <script type="text/javascript">
                                var bchart = new FusionCharts("Swf/ZoomLine.swf", "ChartId1", "1200", "400", "0", "0");
                                bchart.setDataXML("<%=sXMLSlopeDiff%>");
                                bchart.render("BarGraph2");																						
                            </script>
                        </td>
                    </tr>
                    <tr id="TRHighChartZoomingLBI" runat="server" visible="false">
                            ...
                            <table id="ZoomTypeGraph" runat="server" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td id="TdZoomedGraphData" runat="server">
                                        <div id="LBIAndAVGValueZoom" style='width: 1200px; height: 450px; vertical-align: top;'
                                            runat="server">
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <tr id="TRFusionZoomongBattery" runat="server" visible="false">
                        <td>
                            <div id="BarGraph3" style="width: 70%; height: 400;">
                            </div>
                            <script type="text/javascript">
                                var bchart = new FusionCharts("Swf/ZoomLine.swf", "ChartId2", "1200", "400", "0", "0");
                                bchart.setDataXML("<%=sXMLBattery%>");
                                bchart.render("BarGraph3");																						
                            </script>
                        </td>
                    </tr>
                    <tr id="TRHighChartZoomingBattery" runat="server" visible="false">
